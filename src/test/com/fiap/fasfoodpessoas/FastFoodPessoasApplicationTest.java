package com.fiap.fasfoodpessoas;
...
class FastFoodPessoasApplicationTest {
    ...
    void deveValidarClassePossuiApenasMetodoMain() {
        ...
        assertEquals(1, metodos.length);
        assertEquals("main", metodos[0].getName());
    }
    ...
    void deveValidarEnvironmentPossuiPropertySources() {
        ...
        assertTrue(environment.getPropertySources().iterator().hasNext());
    }
